...
export function WhatsAppSignInButton({ disabled }: { disabled?: boolean }) {
  return (
    <OAuthButton provider="facebook" disabled={disabled}>
      <svg className="w-4 h-4 mr-2" viewBox="0 0 24 24" fill="currentColor">
...
export function InstagramSignInButton({ disabled }: { disabled?: boolean }) {
  return (
    <OAuthButton provider="instagram" disabled={disabled}>
      <svg className="w-4 h-4 mr-2" viewBox="0 0 24 24" fill="currentColor">
